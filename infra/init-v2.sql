...
CREATE TABLE IF NOT EXISTS links (
  ...
  link_type       TEXT        NOT NULL DEFAULT '',              -- '' (mention) | 'covers' | 'competes_with' | 'invests_in' | ...
...
CREATE TABLE IF NOT EXISTS raw_files (
  id                BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  source_id         TEXT        NOT NULL DEFAULT 'default',
  raw_path          TEXT        NOT NULL,                       -- 'raw/2026-04-26/meeting_minutes/xxx.md'
...
CREATE INDEX IF NOT EXISTS idx_raw_files_pending       ON raw_files (create_time DESC) WHERE ingested_at IS NULL;
